...
console.log(ceilMath); //Returns the uper integer. Ex: (1.1 = 2) and (1.8 = 2)
...
console.log(signMath); //If value is positive it returns 1, if value is nevetive it returns -1, if value is zero it returns 0, and if value is empty or not an number it returns NaN. Ex: (22 = 1) or (-22 = -1) or (0 = 0)
...
// Math.sqrt
let squreMath = Math.sqrt(81);
console.log(squreMath); //Returns the square root of a number. Ex: (81 = 9)
